...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        // Remove hospital details from database
        $sql = "DELETE FROM `hospital` WHERE `hname` = '$hname'";
...
<body>
    ...
    <?php
        if ($showAlert) {
            ...
            <Strong>Success!</Strong> Hospital is removed from the list.
            </div>';
        }
    ...
    <div>
        <div class="alert alert-danger" role="alert">
            Remove hospital only if you have proper information.
        </div>
        <form action="/DE/removeH.php" method="post" class="container">
